...
export default function TodoForm() {
  ...
  const [createQuote, {error: createQuoteError, isLoading: quoteCreating}] = useCreateQuoteMutation()
  ...
  return (
    <form id="quoteForm" onSubmit={onNewQuote}>
      <h3>New Quote {createQuoteError && createQuoteError.data.message} {quoteCreating && ' coming shortly...'}</h3>

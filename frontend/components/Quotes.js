...
export default function Quotes() {
  ...
  console.log(quotes)
  const [toggleFake, {isLoading: quoteToggling}] = useToggleFakeMutation()
  const [deleteQuote, {isLoading: quoteDeleting}] = useDeleteQuoteMutation()
  //const quotes = [
    // {
    //   id: 1,
  ...
  return (
    <div id="quotes">
      ...
      {quoteToggling && ' switching...'}
      {quoteDeleting && ' being deleted...'}
      </h3>
      <div>
        {
          quotes?.filter(qt => {
